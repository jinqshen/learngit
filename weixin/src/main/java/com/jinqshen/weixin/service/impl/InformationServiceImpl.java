...
import com.jinqshen.weixin.pojo.entity.Finaco;
...
public class InformationServiceImpl implements InformationService {
	...
	@Override
	public void updateFinaco(Finaco finaco) {
		informationMapper.updataFinaco(finaco.getFinacono(),finaco.getStudentnumber(),finaco.getProject(),finaco.getGrade(),finaco.isIsqualified());
